...
export const Step4 = () => {
  ...
  const handleButtonClick = async (e) => {
    ...
    try {
      ...
      const responseAloj = await fetchAlojamiento(
        "api/alojamiento",
        "POST",
        { ...step1Data, ...step2Data },
        step3Data
    ...
    <form onSubmit={handleButtonClick} encType="multipart/form-data">
      ...
      <div className="datosCargados">
        <div className="pasoContainer">
          <ul className="uldatosCargados">
            <h4 className="h4DatosCargado">Datos del Paso 1:</h4>
            <li>
              <b>Nombre:</b> {step1Data.name}
            </li>
            <li>
              <b>Apellido:</b> {step1Data.lastName}
            </li>
            <li>
              <b>DNI:</b> {step1Data.dni}
            </li>
            <li>
              <b>Email:</b> {step1Data.email}
            </li>
            <li>
              <b>Cuil/Cuit:</b> {step1Data.numberCui}
            </li>
            <li>
              <b>Telefono:</b> {step1Data.telefono}
            </li>
            <li>
              <b>Tipo de Alojamiento:</b> {step1Data.tipoAlojamiento}
            </li>
            <li>
              <b>Cantidad Dormitorios:</b> {step1Data.cantDormitorios}
            </li>
            <li>
              <b>Cantidad Baños:</b> {step1Data.cantBanios}
            </li>
            <li>
              <b>Precio: $</b> {step1Data.precio}
            </li>
            <li>
              <b>Brrio:</b> {step1Data.barrio}
            </li>
            <li>
              <b>Calle:</b> {step1Data.calle}
            </li>
        ...
        <div className="pasoContainer">
          <ul className="uldatosCargados">
            <h4 className="h4DatosCargado">Datos del Paso 2:</h4>
            <li>
              <b>Equipamiento:</b> {step2Data.equipamiento}
            </li>
            <li>
              <b>Servicios:</b> {step2Data.servicios}
            </li>
            <li>
              <b>Protecciòn:</b> {step2Data.proteccion}
            </li>
            <li>
              <b>Lugares Cerca:</b> {step2Data.lugaresCerca}
            </li>
            <li>
              <b>Titulo:</b> {step2Data.title}
            </li>
            <li>
              <b>Descripciòn del Alqui:</b> {step2Data.descripcionTotal}
            </li>
        ...
        <div className="pasoContainer">
          <ul className="uldatosCargados">
            <h4 className="h4DatosCargado">Datos del Paso 3:</h4>
      ...
      <hr />
      <hr />
      <button type="submit" className="fullwidth submit campo">
        Enviar
      </button>
